      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          <div data-aos="fade-up" className="top-24 z-50 bg-white rounded-2xl border border-gray-200 shadow-md p-5 space-y-4">
            ...
            <div className="flex items-center gap-2 text-sm px-1 text-gray-500">
              <LucideIcons.ShieldCheck size={14} className="text-gray-400 flex-shrink-0" />
              <span>{lang === 'ar' ? 'سياسة الإلغاء' : 'Cancellation Policy'}</span>
            </div>
